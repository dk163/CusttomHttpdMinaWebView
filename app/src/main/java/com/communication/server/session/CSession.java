...
public class CSession implements Serializable {
	...
	public CSession(IoSession session) {
	...
	public void setPort(int port) {
		...
		setAttribute(Constant.SESSION_KEY, port);
	}
	...
	public void setHeartbeat(Long heartbeat) {
		...
		setAttribute(Constant.HEARTBEAT_KEY, heartbeat);
	}
	...
	public boolean equals(Object o) {
		...
		if (o instanceof CSession) {

			CSession t = (CSession) o;
	...
	public String toString() {
		...
		buffer.append("\"").append("port").append("\":").append("\"").append(port).append("\"").append(",");
