package com.communication.server.http;
...
public class OkHttpClientManager
{
     ...
     * @param callback
     */
    private void _downloadAsyn(final String url, final String destFileDir, final String destFileName, final ResultCallback callback)
    {
        final Request request = new Request.Builder()
                .url(url)
                .build();
            ...
            public void onResponse(Response response)
            {
                ...
                try
                {
                    ...
                    if (TextUtils.isEmpty(destFileName)) {
                    	file = new File(destFileDir, getFileName(url));
                    }
                    else {
    ...
    public static void downloadAsyn(String url, String destDir, String destName, ResultCallback callback)
    {
        getInstance()._downloadAsyn(url, destDir, destName, callback);
    }
